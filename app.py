...
def main():
    ...
    page = st.sidebar.radio(label="", options=["How to use this dashboard","Download Sample file format","Loaded file preview", "Visualize loaded data", "Predictive Modelling"])
    ...
    if page =="How to use this dashboard":
            ...
            st.video('https://www.youtube.com/watch?v=hrIRzGLwpI0')
        ...
        if file is not None:
            ...
            if 'Result' in data.columns:
                ...
                if plots == "Fraud Counts - Area_Service":
                    ...
                    st.write(sns.countplot(data.Code_illness, hue=data.Result))
                    plt.xticks(rotation = 45)
                    st.pyplot()
